...
//            if ($expTableData[$i][$expCellName[$j][0]][1]=='1'){
//                $objPHPExcel->getActiveSheet(0)->getStyle( $cellName[$j] . ($i + 2))->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
//                $objPHPExcel->getActiveSheet(0)->getStyle( $cellName[$j] . ($i + 2))->getFill()->getStartColor()->setARGB('FF999999');
//            }
