...
//						sort : ($(".edit-sku-popup-body article>div.sku-value ul li").length-1),
					...
					if(curr_spec.value[j].spec_show_type == 1){
						sku_display_mode_html += '<li data-spec-value-id="' + curr_spec.value[j].spec_value_id + '" data-spec-show-type="1" class="selected" style="display:none;">';
					}else{
...
$(".edit-sku-popup-body article>div.sku-value ul li:not(.add-sku-value)").live("click",function(){
	...
	if(!$(this).hasClass("selected")){
		...
		if($(".edit-sku-popup-body article>div.sku-display-mode>ul li[data-spec-value-id='" + spec_value_id +"']").length == 0){
			...
			if(spec_show_type == 1){
				display_mode_html = '<li data-spec-value-id="' + spec_value_id + '" data-spec-show-type="1" class="selected">';
			}else{
...
function StringTransference(str, rule, replace){
