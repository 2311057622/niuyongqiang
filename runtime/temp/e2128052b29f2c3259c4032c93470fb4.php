<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:41:"template/adminblue\Goods\goodsImport.html";i:1528526850;s:28:"template/adminblue\base.html";i:1526106064;s:45:"template/adminblue\controlCommonVariable.html";i:1523243571;s:32:"template/adminblue\urlModel.html";i:1511150974;s:48:"template/adminblue\Goods\goodsThreeCategory.html";i:1523243575;s:50:"template/adminblue\Goods\batchProcessingModal.html";i:1523243575;s:52:"template/adminblue\Goods\setMemberDiscountModal.html";i:1527564143;s:34:"template/adminblue\pageCommon.html";i:1525347460;s:34:"template/adminblue\openDialog.html";i:1523243579;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<script src="ADMIN_JS/ajaxFileUpload.js"></script>
<style type="text/css">
...
<div id="bg"></div>
<div id="show">
	<input id="btnclose" type="button" value="关闭" onclick="hidediv();" style="float:right;margin-top:0";/>
	<a href="<?php echo __URL('ADMIN_MAIN/goods/exportGoodsTitle'); ?>"><button>下载模版</button></a>
	<form>
		<table>
			<tr>
				<td>上传文件：</td>
				<td><input type='file' id="file1" name='file'><span id="error"></span></td>
			</tr>
			<tr>
				<td colspan="2"><input type="button" id="import" value="提交"></td>
			</tr>
		</table>
	</form>
...
<table class="mytable">
	<tr>
		<th align="left">
			<a class="btn-common" href="javascript:;" onclick="showdiv();">商品导入</a>
			...
			<a href="javascript:;" id="setMemberDiscount"  class="btn-common-white" title="设置折扣">设置折扣</a>
			<a href="javascript:;" onclick="javascript:zhangxiuerpstock();"  class="btn-common-white" title="同步掌秀ERP库存">同步掌秀SKU信息</a>
			<a href="javascript:;" onclick="javascript:erpstock();"  class="btn-common-white" title="同步掌秀ERP库存">同步掌秀SKU库存</a>
...
<script type="text/javascript">
    ...
    function ajaxFileUpload() {
        ...
        (
            {
                url: "<?php echo __URL('ADMIN_MAIN/goods/goodsImport'); ?>", //用于文件上传的服务器端请求地址
    ...
    function erpstock(goods_id) {
        $.ajax({
            type : "post",
            url : "<?php echo __URL('ADMIN_MAIN/goods/erpStock'); ?>",
            data : {
                "goods_id" : goods_id,
            },
            // jsonType:"json",
    ...
    //同步掌秀云erpSKU信息
    function zhangxiuerpstock(goods_id) {
        $.ajax({
            type : "post",
            url : "<?php echo __URL('ADMIN_MAIN/goods/zhangxiuErp'); ?>",
            data : {
                "goods_id" : goods_id,
            },
            // jsonType:"json",
            success : function(data){
                ...
                if(data.data!=null){
                    zhangxiuerpstock(data.data.goods_id);
				}else{
                    showTip(data.msg,"warning");
				}
            }
